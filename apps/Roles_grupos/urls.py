...
urlpatterns = [
    ...
    path('rol/formulario/<int:rol_id>/', RolFormView.as_view(), name='rol_formulario_edit'),
    # Ruta para obtener el formulario de un rol (para HTMX)
    path('editar/<int:edit_id>/', RolesHomeView.as_view(), name="home_edit"), # Misma vista, diferente comportamiento
